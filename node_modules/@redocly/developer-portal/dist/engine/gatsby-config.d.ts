...
export declare const plugins: ("gatsby-plugin-react-helmet" | "gatsby-plugin-layout" | "@redocly/gatsby-plugin-sharp" | "gatsby-plugin-nprogress" | "gatsby-plugin-styled-components" | "gatsby-plugin-typescript" | "gatsby-plugin-sitemap" | "gatsby-plugin-redirect" | {
    resolve: string;
    options?: undefined;
} | {
    resolve: string;
