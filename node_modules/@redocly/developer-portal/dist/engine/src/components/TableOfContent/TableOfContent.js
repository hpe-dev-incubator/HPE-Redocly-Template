import*as React from"react";import styled from"../../styled-components";import{darken}from"polished";import*as GithubSlugger from"github-slugger";import throttle from"lodash.throttle";import{useFullHeight}from"../../hooks";import{mediaCSS}from"@redocly/reference-docs";const slugger=new GithubSlugger;function useActiveHeading(a){const[b,c]=React.useState(void 0),d=React.useMemo(()=>a&&a.querySelectorAll("h1[id], h2[id], h3[id], h4[id]"),[a]),e=React.useCallback(throttle(()=>{if(d)for(let a=0;a<d.length;a++)if(d[a].offsetTop>window.scrollY){const b=0===a?void 0:d[a-1].getAttribute("id")||void 0;return void c(b)}}),[d]);return React.useEffect(()=>{if("undefined"!=typeof window&&d&&d.length)return window.addEventListener("scroll",e,{capture:!1}),e(),()=>window.removeEventListener("scroll",e)},[e]),b}export default function TableOfContent(a){const{headings:b,tocMaxDepth:c}=a,d=React.useRef(null);useFullHeight(d);const e=useActiveHeading(a.contentWrapper);return slugger.reset(),b&&1===b.length&&1===b[0]?.depth?null:React.createElement(React.Fragment,null,b&&React.createElement(TableOfContentMenu,null,React.createElement(TableOfContentItems,{ref:d},b.map((a,b)=>{if(0===b&&1===a.depth)return null;if(a.depth&&a.depth>c)return null;const d="#"+slugger.slug(a.value,!1);return React.createElement(MenuItem,{key:d,depth:a.depth||0,href:d,className:"#"+e==d?"active":"",dangerouslySetInnerHTML:{__html:a.value||""},"data-cy":`toc-${a.value}`})}))))}const MenuItem=styled.a`
  display: block;
