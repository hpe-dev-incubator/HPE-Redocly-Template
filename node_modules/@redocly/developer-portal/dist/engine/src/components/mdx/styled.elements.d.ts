export declare const RedocComponentWrap: import("styled-components").StyledComponent<"div", {
    spacing: {
        unit: number;
...
export declare const OpenApiExampleWrap: import("styled-components").StyledComponent<"div", {
    spacing: {
        unit: number;
        sectionHorizontal: number;
        sectionVertical: number;
