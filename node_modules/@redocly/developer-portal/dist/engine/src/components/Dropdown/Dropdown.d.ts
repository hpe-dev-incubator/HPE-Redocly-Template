import { default as Dropdown, DropdownTrigger } from 'react-simple-dropdown';
declare const StyledDropwDownContent: import("styled-components").StyledComponent<any, {
    spacing: {
        unit: number;
