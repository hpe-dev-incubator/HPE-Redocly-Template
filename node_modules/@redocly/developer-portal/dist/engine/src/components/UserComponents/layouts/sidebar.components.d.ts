export declare const MenuMobileButton: import("styled-components").StyledComponent<"span", {
    spacing: {
        unit: number;
...
export declare const MenuWrapper: import("styled-components").StyledComponent<"aside", {
    spacing: {
        unit: number;
        sectionHorizontal: number;
        sectionVertical: number;
