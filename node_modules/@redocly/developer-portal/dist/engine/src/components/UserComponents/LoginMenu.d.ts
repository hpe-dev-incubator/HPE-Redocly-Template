...
export declare function LoginMenu({ mobile }: LoginMenuProps): JSX.Element;
export declare const ArrowIcon: import("styled-components").StyledComponent<"i", {
    spacing: {
        unit: number;
...
export declare const PopupMenu: import("styled-components").StyledComponent<"ul", {
    spacing: {
        unit: number;
        sectionHorizontal: number;
        sectionVertical: number;
