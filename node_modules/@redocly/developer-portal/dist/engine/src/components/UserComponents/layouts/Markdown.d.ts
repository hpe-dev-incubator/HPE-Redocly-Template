...
export declare type MarkdownLayoutProps<T extends any = any> = React.PropsWithChildren<{
    withToc: boolean;
    lastModified?: Date | string | number;
    lastModifiedAgo?: string;
    Toc: React.FunctionComponent;
    headings?: Array<MarkdownHeading | null> | null;
    contentWrapper: HTMLElement | null;
    location: Location;
    frontmatter: T;
    pageId?: string;
}>;
export default function UserMarkdownLayout(props: MarkdownLayoutProps): JSX.Element;
export declare const PageWrapper: import("styled-components").StyledComponent<"div", {
    spacing: {
        unit: number;
