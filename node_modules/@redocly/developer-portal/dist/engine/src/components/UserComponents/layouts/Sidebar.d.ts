...
export declare type SidebarProps<T = unknown> = React.PropsWithChildren<{
    location: Location;
    items: NavItem[];
    context: T;
    prevPage?: {
    ...
    isReferenceDocs: boolean;
    withToc: boolean;
    pageId: string;
    apiVersionId?: string;
    apiVersions: any[];
}>;
export default function SidebarLayout(props: SidebarProps): JSX.Element;
