...
export declare function genTokens(tokens?: Tokens | null): string | import("styled-components").FlattenInterpolation<import("styled-components").ThemeProps<import("@redocly/reference-docs").ResolvedThemeInterface>>;
