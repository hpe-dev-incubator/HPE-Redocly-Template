...
export declare const NextSectionButton: import("styled-components").StyledComponent<"button", import("../redoc-lib").ResolvedThemeInterface, import("./shared/Button").ButtonProps, never>;
