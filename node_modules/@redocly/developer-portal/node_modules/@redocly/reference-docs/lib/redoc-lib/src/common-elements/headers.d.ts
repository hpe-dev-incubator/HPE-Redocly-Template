...
export declare const RightPanelHeader: import("styled-components").StyledComponent<"h3", import("../theme").ResolvedThemeInterface, {}, never>;
export declare const FieldsGroupHeader: import("styled-components").StyledComponent<"h5", import("../theme").ResolvedThemeInterface, {}, never>;
