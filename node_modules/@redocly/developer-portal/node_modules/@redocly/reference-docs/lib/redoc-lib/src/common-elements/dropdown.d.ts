...
export declare const darkDropdownStyle: import("styled-components").FlattenInterpolation<import("styled-components").ThemeProps<import("../theme").ResolvedThemeInterface>>;
